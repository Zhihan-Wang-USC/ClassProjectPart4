...
public class TableManagerImpl implements TableManager{
  ...
  /***
   * Return TableMetadata if the table exists, otherwise return null
   */
  @Override
...
//    FDBHelper.commitTransaction(readTx);
  ...
  public StatusCode addAttributeTx(Transaction tx, String tableName, String attributeName, AttributeType attributeType) {
    // your code
//    Transaction tx = FDBHelper.openTransaction(db);
    // check if the table exists
    if (!FDBHelper.doesSubdirectoryExists(tx,Collections.singletonList(tableName))) {
